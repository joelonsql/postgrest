...
data DbActionPlan = DbCall CallReadPlan | MaybeDb InspectPlan
data InfoPlan     = RoutineInfoPlan CallReadPlan | SchemaInfoPlan
...
addRanges ApiRequest{..} rReq = foldr addRangeToNode (Right rReq) =<< ranges
  where
