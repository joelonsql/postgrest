...
--
-- >>> serverTimingHeader ServerTiming { plan=Just 0.1, transaction=Just 0.2, response=Just 0.3, parse=Just 0.5}
-- ("Server-Timing","parse;dur=500.0, plan;dur=100.0, transaction;dur=200.0, response;dur=300.0")
